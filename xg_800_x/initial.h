...
#ifndef SRC_INITIAL_H_
#define SRC_INITIAL_H_

//zhou modified in 2019.01.10
...
AD9361_InitParam default_init_param = {
	...
	/* LO Control */
	630000000UL,	//rx_synthesizer_frequency_hz *** adi,rx-synthesizer-frequency-hz
	630000000UL,	//tx_synthesizer_frequency_hz *** adi,tx-synthesizer-frequency-hz
	1,				//tx_lo_powerdown_managed_enable *** adi,tx-lo-powerdown-managed-enable
	/* Rate & BW Control */
	{819200000, 204800000, 102400000, 51200000, 25600000, 25600000},// rx_path_clock_frequencies[6] *** adi,rx-path-clock-frequencies
	{819200000, 204800000, 102400000, 51200000, 25600000, 25600000},// tx_path_clock_frequencies[6] *** adi,tx-path-clock-frequencies
	...
	1,    //CLKOUT_DISABLE,	//clk_output_mode_select *** adi,clk-output-mode-select
	/* Gain Control */
	0,		//gc_rx1_mode *** adi,gc-rx1-mode modified： 20190729 原值为2
	0,		//gc_rx2_mode *** adi,gc-rx2-mode modified： 20190729 原值为2
